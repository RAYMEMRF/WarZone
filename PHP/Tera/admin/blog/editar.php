...
$consulta = "SELECT * FROM blog WHERE id = ".$_GET['ref'];
$query = query($consulta);
$resultado = fetch_array($query);
?>

        <div class="page-header">
            <h1><a href="index.php"><img style="width: 64px; height: 64px;" src="<?=HTTP_ROOT?>/resources/img/1377071569_blog.png" class="img-rounded" title="Blog" /></a>Blog&nbsp;<small>Editar</small></h1>
        </div>
        <form class="form-horizontal" action="index.php" method="POST" novalidate>
           ...
           <div class="form-group">
            <!-- Autor -->
                ...
                <div class="col-lg-10">
                    <input type="text" id="autor" name="autor" placeholder="" class="form-control input-sm" value="<?=$resultado['autor']?>" required>
                </div>
                <div class="clearfix"></div>
           ...
           <div class="form-group">
            <!-- Titulo -->
                ...
                <div class="col-lg-10">
                    <input type="text" id="link" name="link" placeholder="" class="form-control input-sm" value="<?=$resultado['link']?>" required>
                </div>
                <div class="clearfix"></div>
            ...
            <!-- Parrafo -->
                ...
                <div class="col-lg-10">
                    <textarea class="form-control textarea" rows="12" name="entrada"><?=htmlspecialchars($resultado['entrada'])?>"</textarea>
                </div>
            </div>
