...
?>
        ...
        <div class="page-header">
            <h1><a href="index.php"><img style="width: 64px; height: 64px;" src="<?=HTTP_ROOT?>/resources/img/Cloud-icon.png" class="img-rounded" title="Servicios" /></a>Servicios&nbsp;<small>Agregar</small></h1>
        </div>
        <form enctype="multipart/form-data" class="form-horizontal" action="index.php" method="POST" novalidate>
           <div class="form-group">
            ...
            <div class="form-group">
            <!-- Imagen-->
                <input id="linkfile" name="linkfile" type="file" style="display:none">
