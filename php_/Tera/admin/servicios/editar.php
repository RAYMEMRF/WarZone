...
$consulta = "SELECT * FROM servicios WHERE id = ".$_GET['ref'];
$query = query($consulta);
$resultado = fetch_array($query);
?>

        <div class="page-header">
            <h1><a href="index.php"><img style="width: 64px; height: 64px;" src="<?=HTTP_ROOT?>/resources/img/1377591956_sharemanager.png" class="img-rounded" title="Servicios" /></a>Servicios&nbsp;<small>Editar</small></h1>
        </div>
        <form enctype="multipart/form-data" class="form-horizontal" action="index.php" method="POST" novalidate>
           ...
           <div class="form-group">
            <!-- Titulo -->
                ...
                <div class="col-lg-4">
                    <input type="text" id="titulo" name="titulo" placeholder="" class="form-control input-sm" value="<?=$resultado['titulo'];?>">
                </div>
                <div class="clearfix"></div>
            ...
            <!-- Descripcion -->
                ...
                <div class="col-lg-4">
                    <textarea class="form-control" rows="3" name="descripcion"><?=$resultado['parrafo'];?></textarea>
                </div>
                <div class="clearfix"></div>
