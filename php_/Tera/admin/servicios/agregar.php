...
?>
        ...
        <div class="page-header">
            <h1><a href="index.php"><img style="width: 64px; height: 64px;" src="<?=HTTP_ROOT?>/resources/img/1377591956_sharemanager.png" class="img-rounded" title="Servicios" /></a>Servicios&nbsp;<small>Agregar</small></h1>
        </div>
