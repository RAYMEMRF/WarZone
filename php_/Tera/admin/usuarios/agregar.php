...
?>
        ...
        <div class="page-header">
            <h1><a href="index.php"><img style="width: 64px; height: 64px;" src="<?=HTTP_ROOT?>/resources/img/1376856270_preferences-contact-list.png" class="img-rounded" title="Usuarios" /></a>Usuarios&nbsp;<small>Agregar</small></h1>
        </div>
        <form class="form-horizontal" action="index.php" method="POST" novalidate>
            ...
            <!-- Nombre -->
                ...
                <div class="col-lg-4">
                    <input type="text" id="name" name="name" placeholder="" class="form-control input-sm" required>
                </div>
           ...
           <div class="form-group">
            <!-- Username -->
                ...
                <div class="col-lg-4">
                    <input type="text" id="username" name="username" placeholder="" class="form-control input-sm" required>
                </div>
                <div class="clearfix"></div>
            ...
            <!-- E-mail -->
                ...
                <div class="col-lg-4">
                    <input type="email" id="email" name="email" placeholder="" class="form-control input-sm">
                </div>
                <div class="clearfix"></div>
            ...
            <!-- Password-->
                ...
                <div class="col-lg-4">
                    <input type="password" id="password" name="password" placeholder="" class="form-control input-sm" required>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="password" id="password_confirm" name="password_confirm" placeholder="" class="form-control input-sm"
