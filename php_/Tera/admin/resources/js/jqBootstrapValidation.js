    ...
    methods: {
        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Formato de correo electr&oacute;nico inv&aacute;lido<!-- data-validation-email-message to override -->";
      ...
      ajax: {
        ...
        validate: function ($this, value, validator) {
          ...
          var message = "Formato de correo electr&oacute;nico inv&aacute;lido";
          if ($this.data("validation" + name + "Message")) {
            message = $this.data("validation" + name + "Message");
          }
      ...
      number: {
		...
		builtInValidators: {
			...
			integer: {
				...
				type: "regex",
				regex: "[+-]?\\d+",
				message: "Por favor, escribe un n&uacute;mero entero v&aacute;lido<!-- data-validator-integer-message to override -->"
			},
			positivenumber: {
				name: "Positivenumber",
				type: "min",
