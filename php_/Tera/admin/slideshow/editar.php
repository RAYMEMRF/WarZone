...
$consulta = "SELECT * FROM slideshow WHERE id = ".$_GET['ref'];
$query = query($consulta);
$resultado = fetch_array($query);
?>

        <div class="page-header">
            <h1><a href="index.php"><img style="width: 64px; height: 64px;" src="<?=HTTP_ROOT?>/resources/img/1376880330_HP-Projector2.png" class="img-rounded" title="Usuarios" /></a>Slideshow&nbsp;<small>Editar</small></h1>
        </div>
        <form enctype="multipart/form-data" class="form-horizontal" action="index.php" method="POST" novalidate>
            ...
            <!-- Encabezado -->
                ...
                <div class="col-lg-4">
                    <input type="text" id="encabezado" name="encabezado" placeholder="" class="form-control input-sm"  value="<?=$resultado['encabezado']?>" required>
                </div>
           ...
           <div class="form-group">
            <!-- Titulo -->
                ...
                <div class="col-lg-4">
                    <input type="text" id="titulo" name="titulo" placeholder="" class="form-control input-sm" value="<?=$resultado['titulo']?>" required>
                </div>
                <div class="clearfix"></div>
            ...
            <!-- Parrafo -->
                ...
                <div class="col-lg-4">
                    <textarea class="form-control" rows="3" name="parrafo"><?=$resultado['parrafo']?></textarea>
                </div>
                <div class="clearfix"></div>
            ...
            <!-- Imagen-->
                ...
                <div class="input-group col-lg-6">
                    <input type="text" id="imagen" name="imagen" placeholder=""  value="<?=$resultado['imagen']?>" class="form-control input-sm">
            ...
            <div class="form-group">
                ...
                <div class="input-group col-lg-6">
                    <input type="text" id="miniatura" name="miniatura" placeholder=""  value="<?=$resultado['miniatura']?>"  class="form-control input-sm">
                    <span class="input-group-btn">
