                        ...
                        <? if (get_setting('clientes')) { ?>
                            ...
                            <? if (get_setting('soporte')) { ?>
                                ...
                                <? if (get_setting('pagos')) { ?>
                                    ...
                                    <p class="copy">Este sitio web fue desarrollado por <a target="_blank" href="http://www.cesca-software.com/web/" target="_blank">cesca-software.com</a> &copy; 2013 | <a href="admin/" title="Panel administrador">Hola<img src="css/images/1381399534_computer_key.png" height="12" width="12"></a></p>
                                    <div class="cl">&nbsp;</div>
                                </div>
                                <!-- end of footer -->
                            </div>
